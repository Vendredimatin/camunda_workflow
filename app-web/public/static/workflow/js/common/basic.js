...
var offsetHost = parseInt(location.port) - 8180;
...
CommandStack.prototype = {
	execute : function(command) {
		this._clearRedo();
    if(this.redoButton) this.redoButton.setAttribute("disabled", "");
    if(this.undoButton) this.undoButton.removeAttribute("disabled");
		command.execute();
    ...
    var savebutton = document.getElementById("savebutton"+this.pid);
		if (this.isDirty()) {
