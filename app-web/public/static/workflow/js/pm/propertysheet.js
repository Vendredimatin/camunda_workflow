...
(function ($, window, document, undefined) {
    ...
    PropertySheet.prototype.init = function (options) {
        ...
        // this.refreshButton = this.createToolbarItem(panelToolbar, "refreshattr",
        // "刷新", "glyphicon glyphicon-refresh", "btn btn-primary btn-xs");
    ...
    PropertySheet.prototype.doClick = function (evt) {
      if (evt.target == this.addButton || evt.target.id == "addnew") {
        ...
        //     this.modifyRow(evt);
      } else if (evt.target == this.removeButton || evt.target.id == "removeone") {
        this.removeRow(evt);

      }else if(evt.target == this.refreshButton || evt.target.id == "refreshattr"){
        console.log("PropertySheet doClick refreshRow");
        this.refreshRow(evt);
      }else {
    ...
    PropertySheet.prototype.refreshRow = function(evt){
      if (this.entity instanceof WfProcess) {
        console.log("PropertySheet.refreshRow");
        this.procEditPlugin.refreshRow(evt);
    ...
    PropertySheet.prototype.addRow = function (evt) {
        console.log("addevt",evt);
        if (this.entity instanceof WfProcess) {
            // this.procVariablesPlugin.addRow(evt);
            this.procEditPlugin.addRow(evt);
        } else if (this.entity instanceof AssignTask) {
            this.assignmentRditPlugin.addRow(evt);
        } else if (this.entity instanceof SubprocessPoint) {
            this.subprocessTaskRditPlugin.addRow(evt);
    ...
    PropertySheet.prototype.modifyRow = function (evt) {
        if (this.entity instanceof WfProcess) {
            ...
            this.procEditPlugin.modifyRow(evt);
        } else if (this.entity instanceof AssignTask) {
    ...
    PropertySheet.prototype.removeRow = function (evt) {
        if (this.entity instanceof WfProcess) {
            ...
            this.procEditPlugin.removeRow(evt);
        } else if (this.entity instanceof AssignTask) {
            ...
            this.manualTaskRditPlugin.removeRow(evt);
        }
    };
    ...
    PropertySheet.prototype.setSheet = function (obj, owner, tabindex) {
        ...
        if (this.entity instanceof WfProcess) {
            ...
            if (this.procEditPlugin == null) {
                this.initProcessEditPane(this.panelBody);
            } else {
                this.procEditPlugin.loadPane(this.entity);
            }
    ...
    PropertySheet.prototype.initProcessEditPane = function (parent) {
        ...
        this.procEditPlugin = plugin.data("processEditPanel");
    };


    PropertySheet.prototype.initRlProcessEditPane = function (parent) {
        var plugin = $(parent).proprietorSettingPane({
            id: "rp001",
            parent: this,
            entity: this.entity,
            topparent: this.topparent,
        ...
        this.proprietorPlugin = plugin.data("proprietorSettingPane");
    };
