<template>
    <div style="width: 100%;height: 100%;">
        <iframe id="urlFrame" :src="urlSrc" frameborder="0" width="100%" :height="iHeight"></iframe>
    </div>
</template>
    ...
    export default {
        ...
        methods: {
            ...mapActions("DWF_form", ["updateFView", "deleteFView", "queryEntity", "queryRelation", "handleQueryData", "handleQueryForm",
                "deleteEObj", "saveEObj", "editEObj", "refreshEObj", "updateFormJsonAct", "updataEntityobjAct",
            ...
            async handleScript(code, params, store, jsonData) {
                ...
                let that = this;
                let _params = { dwf_axios: dwf_app_axios, dwf_modeler_axios: axios, axios: Axios.create({ baseURL: "", withCredentials: true }),
