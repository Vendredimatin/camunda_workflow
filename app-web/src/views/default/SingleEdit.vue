<template>
    <div class="create self-form-layout" style="height: 100%;">
        ...
        <FormEngine ref="form" :to_path='rpath' :to_query="rquery" :store="store" :root="root" :echarts="echarts" :isSingleTab="isSingleTab"></FormEngine>
    </div>
</template>
...
<script>
    ...
    export default {
        ...
        props: ['route', 'store', 'root', 'query', 'echarts', 'isSingleTab'],
        data() {
            return {
                title:'',
                rpath:'',
        ...
        created () {
            ...
            this.rquery.params.opr_path = 'edit';
            this.rquery.displayType = "edit";
            console.log("created:", this.rquery, this.route);
        },
        mounted() {
            console.log("mounted");
        },
