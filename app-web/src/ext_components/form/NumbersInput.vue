<template>
        <section :addinName="name" :style="{'font-size': '14px', 'width': colWidth}" ref="main">
            <label v-if="args.label" class="ori-color self-color" :style="{'width': labelWidth, 'display': 'inline-block', 'text-align': labelXAlign, 'vertical-align': labelYAlign}">{{ args.label }}</label>
           ...
           :placeholder="args.placeholder"
            ...
            :style="{'height': args.basic_height * args.height + 'px', 'font-size': '14px', 'width': '40%', 'display': 'inline-block', 'text-align': mainXAlign, 'vertical-align': mainYAlign, 'color': 'initial',}"
...
<script>
	...
	times: 0,
        ...
        methods: {
          ...
          setInheritStyle() {
            this.$refs.number.$el.querySelector(".ivu-input-number-input").style.color = 'inherit';
            this.$refs.number.$el.querySelector(".ivu-input-number-input-wrap").style.fontSize = 'inherit';
            this.$refs.number.$el.querySelector(".ivu-input-number-input").style.fontSize = 'inherit';
            this.$refs.number1.$el.querySelector(".ivu-input-number-input").style.color = 'inherit';
            this.$refs.number1.$el.querySelector(".ivu-input-number-input-wrap").style.fontSize = 'inherit';
            this.$refs.number1.$el.querySelector(".ivu-input-number-input").style.fontSize = 'inherit';
          },
