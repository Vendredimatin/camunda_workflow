    ...
    if (this.t_preview) {
      ...
      if (this.args.htmlCode == "") {
        this.args.htmlCode = "<html>\n" +
          "<head>\n" +
        '\t<meta charset="utf-8">\n' +
        '\t<!-- <link rel="stylesheet" type="text/css" href="http://unpkg.com/vant/lib/index.css">\n' +
        '\t<link rel="stylesheet" type="text/css" href="http://unpkg.com/vant/lib/icon/local.css">\n' +
        '\t<link rel="stylesheet" type="text/css" href="http://unpkg.com/vant/lib/icon/index.css">\n' +
        '\t<script type="text/javascript" src="http://v1.vuejs.org/js/vue.min.js"><\/script>\n' +
        '\t<script type="text/javascript" src="http://unpkg.com/vant/lib/vant.min.js"><\/script> -->\n' +
        '<\/head>\n' +
        '<body>\n' +
        '<!-- \n' +
        '<div id="app">\n' +
      ...
      if (this.args.vueCode == "") {
        ...
        "\n" +
        '@import "../../node_modules/vant/lib/icon/index.css";\n' +
        "*/\n" +
        "<\/style>"
      }
    }
