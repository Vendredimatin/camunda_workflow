...
<!--                                        style="width:100%"></BindOperationBar>-->
                    ...
                    <p class="margin1">
                      ...
                      <i-Switch v-model="args.auth" @on-change="onChangeOfSwitch"></i-Switch> &nbsp;
                    ...
                    <Select class="margin1" v-model="args.icon" filterable>
...
import OperationAuthModal from "./subcomponent/OperationAuthModal.vue"
...
export default {
  ...
  props: [
    ...
    components: {BindOperationBar, EditBox, OperationAuthModal},
  ...
  mounted() {
    ...
    methods: {
      ...
      freshTable() {
        ...
        // this.args.chooseTable = _.intersection(this.args.chooseTable, this.tableList);
      },
      ...
      handleChangeEventOfOperationBar(event) {
        ...
        // 处理基本操作
          ...
          if(this.args.opr_path === event.conf.opr_path){
            this.args.text = this.args.text === '按钮' ? event.opr_displayName : this.args.text;
          }else{
