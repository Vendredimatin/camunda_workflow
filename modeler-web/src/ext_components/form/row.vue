...
<!--            </Select>-->
    ...
    <span v-show="t_edit_col" ref="edit_col">
      ...
      <EditBox v-if="actEdit" :addinName="name" v-model="c_col">
        ...
        <div slot="layout">
          <div class="margin1" style="height: 1px;">
          ...
          <div class="margin1" style="margin: 10px 0 10px 0">
            ...
            <Row type="flex" align="middle">
              ...
              <Col span="8" style="margin-top: -2px;">
...
export default {
  ...
  methods: {
    ...
    // 同步设置边距值
    attachMargin() {
      this.c_col.leftBorder.color = this.c_col.rightBorder.color = this.c_col.bottomBorder.color = this.c_col.topBorder.color;
      this.c_col.leftBorder.width = this.c_col.rightBorder.width = this.c_col.bottomBorder.width = this.c_col.topBorder.width;
      this.c_col.leftBorder.style = this.c_col.rightBorder.style = this.c_col.bottomBorder.style = this.c_col.topBorder.style;
    },
  }
}
</script>
