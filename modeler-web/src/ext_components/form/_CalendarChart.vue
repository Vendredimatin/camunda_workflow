                ...
                <div slot="attribute">
                    <div class="editsection">
                        <Form :model="args" :label-width="80">
                            ...
                            <p class="margin1">年份</p>
                            <InputNumber class="margin1" v-model="args.calendarYear" :min='1990' :step='1'></InputNumber>

                            <p class="margin1">日期</p>
  ...
  methods: {
    ...
    render(){
      if(!this.args.nameAttribute) {
        ...
        this.args.option.calendar = {
            range: this.args.calendarYear + '',
        }
        this.args.option.series = [];
        this.args.option.series.push({
                  ...
                  data: (() => {
                      ...
                      this.args.option.dataset.source.slice(1).forEach(x => (res.push(
                          (() => {
                              let r = [];
                              r.push(x[this.nameIndex]);
                              r.push(x[this.valueIndex]);
                              return r;
                          })()
                          )));
                      return res;
