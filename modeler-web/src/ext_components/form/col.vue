<template>
  <section
    ...
    :style="{
      'width': arg_width,
      'margin': `${arg_mt} ${arg_mr} ${arg_mb} ${arg_ml}`,
            ...
            <EditBox v-if="actEdit" :addinName="name" :widgetAnnotation="widgetAnnotation" :editExtendInfo="editExtendInfo" ref="editbox" v-model="args">
                <div slot="attribute">
                    ...
                    <Row type="flex" align="middle">
                      ...
                      <Col span="18">
                        <Input class="margin1" type="number" v-model="args.ltRadius" @on-change="radiusChange(args.ltRadius, 'lt')">
                    ...
                    <Row type="flex" align="middle">
                      ...
                      <p class="margin1" style="float: left; margin-right: 10px;">阴影颜色</p>
                      <ColorPicker v-model="args.shadowColor" alpha/>
                    </Row>
                </div>
              <div slot="layout">
