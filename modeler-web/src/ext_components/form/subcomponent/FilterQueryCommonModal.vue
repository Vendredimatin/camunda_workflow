        ...
        <Row type="flex" justify="center" align="middle" style="max-height: 400px;overflow-y: scroll;">
          <Col span="24">
            <Tabs :value="filterQueryGroup" name="filterQueryGroup">
              <TabPane label="obj" name="obj" tab="filterQueryGroup" :disabled="!filterQueryRefClass">
                <div v-if="refClassSwitch">
                  <Collapse v-model="defaultRefOpen">
                    <Panel name="1">
                      系统属性
                      <div slot="content">
                        <Row type="flex" align="middle" justify="start">
                          <Col span="8"  v-for="(refClassAttribute, index) in refClassAttributes.sys" :key="index" :style="attributeBoxStyle">
                            <div class="filterQuery-box">
                              ...
                              <Button class="filterQuery-add" size="small" @click="addAttribute('obj', refClassAttribute)">添加</Button>
                            </div>
                          </Col>
                        </Row>
                      </div>
                    ...
                    <Panel name="2">
                      ...
                      <div slot="content">
                        <Row type="flex" align="middle" justify="start">
                          <Col span="8"  v-for="(refClassAttribute, index) in refClassAttributes.def" :key="index" :style="attributeBoxStyle">
                            <div class="filterQuery-box">
                              <span :title="refClassAttribute.displayName" class="filterQuery-display">{{refClassAttribute.displayName}}</span>
                              <span :title="refClassAttribute.attributeName" class="filterQuery-attribute">{{refClassAttribute.attributeName}}</span>
                              <Button class="filterQuery-add" size="small" @click="addAttribute('obj', refClassAttribute)">添加</Button>
                    ...
                    <div slot="content">
                      <Collapse v-model="defaultRelationRefOpen">
                        <Panel name="1-1">
                          ...
                          <div slot="content">
                            <Row type="flex" align="middle" justify="start" >
                            <Col span="8"  v-for="(relation, index) in refClassAttributes.relationSys" :key="index" :style="attributeBoxStyle">
                              <div class="filterQuery-box">
                                ...
                                <Button class="filterQuery-add" size="small" @click="addAttribute('obj', relation, 'relation_')">添加</Button>
                              </div>
                            </Col>
                          </Row>
                          </div>
                        ...
                        <Panel name="1-2">
                          ...
                          <div slot="content">
                            <Row type="flex" align="middle" justify="start" >
                            <Col span="8"  v-for="(relation, index) in refClassAttributes.relationDef" :key="index" :style="attributeBoxStyle">
                              <div class="filterQuery-box">
                                <span :title="relation.displayName" class="filterQuery-display">{{relation.displayName}}</span>
                                <span :title="relation.attributeName" class="filterQuery-attribute">{{relation.attributeName}}</span>
                                <Button class="filterQuery-add" size="small" @click="addAttribute('obj', relation, 'relation_')">添加</Button>
                    ...
                    <div slot="content">
                      <Collapse v-model="defaultLeftRefOpen">
                        <Panel name="2-1">
                          ...
                          <div slot="content">
                            <Row type="flex" align="middle" justify="start" >
                            <Col span="8"  v-for="(left, index) in refClassAttributes.leftSys" :key="index" :style="attributeBoxStyle">
                              <div class="filterQuery-box">
                                ...
                                <Button class="filterQuery-add" size="small" @click="addAttribute('obj', left, 'left_')">添加</Button>
                              </div>
                            </Col>
                          </Row>
                          </div>
                        ...
                        <Panel name="2-2">
                          ...
                          <div slot="content">
                            <Row type="flex" align="middle" justify="start" >
                            <Col span="8"  v-for="(left, index) in refClassAttributes.leftDef" :key="index" :style="attributeBoxStyle">
                              <div class="filterQuery-box">
                                <span :title="left.displayName" class="filterQuery-display">{{left.displayName}}</span>
                                <span :title="left.attributeName" class="filterQuery-attribute">{{left.attributeName}}</span>
                                <Button class="filterQuery-add" size="small" @click="addAttribute('obj', left, 'left_')">添加</Button>
                    ...
                    <div slot="content">
                      <Collapse v-model="defaultRightRefOpen">
                        <Panel name="3-1">
                          ...
                          <div slot="content">
                            <Row type="flex" align="middle" justify="start" >
                            <Col span="8"  v-for="(right, index) in refClassAttributes.rightSys" :key="index" :style="attributeBoxStyle">
                              <div class="filterQuery-box">
                                ...
                                <Button class="filterQuery-add" size="small" @click="addAttribute('obj', right, 'right_')">添加</Button>
                              </div>
                            </Col>
                          </Row>
                          </div>
                        ...
                        <Panel name="3-2">
                          ...
                          <div slot="content">
                            <Row type="flex" align="middle" justify="start" >
                            <Col span="8"  v-for="(right, index) in refClassAttributes.rightDef" :key="index" :style="attributeBoxStyle">
                              <div class="filterQuery-box">
                                <span :title="right.displayName" class="filterQuery-display">{{right.displayName}}</span>
                                <span :title="right.attributeName" class="filterQuery-attribute">{{right.attributeName}}</span>
                                <Button class="filterQuery-add" size="small" @click="addAttribute('obj', right, 'right_')">添加</Button>
                      ...
                      <div slot="content">
                        ...
                        <Col span="8" v-for="(objAttribute, index) in objAttributes.sys" :key="index" :style="attributeBoxStyle">
                          <div class="filterQuery-box">
                            ...
                            <Button class="filterQuery-add" size="small" @click="addAttribute('$obj', objAttribute)">添加</Button>
                          </div>
                        </Col>
                      </Row>
                      </div>
              ...
              <TabPane v-if="hideTab" label="$user" name="$user" tab="filterQueryGroup">
                <Col span="8"  v-for="(userAttribute, index) in userAttributes" :key="index" :style="attributeBoxStyle">
                  <div class="filterQuery-box">
                    ...
                    <Button class="filterQuery-add" size="small" @click="addAttribute('$user', userAttribute)">添加</Button>
                  </div>
                </Col>
              </TabPane>
              <TabPane v-if="hideTab" label="$env" name="$env" tab="filterQueryGroup">
                <Col span="8"  v-for="(envAttribute, index) in envAttributes" :key="index" :style="attributeBoxStyle">
                  <div class="filterQuery-box">
                    ...
                    <Button class="filterQuery-add" size="small" @click="addAttribute('$env', envAttribute)">添加</Button>
                  </div>
                </Col>
              </TabPane>
              <TabPane v-if="hideTab && !fromManagement" label="$form" name="$form" tab="filterQueryGroup">
                <Col span="8"  v-for="(formAttribute, index) in formAttributes" :key="index" :style="{'height': '60px', 'margin': '5px 0'}">
                  <div class="filterQuery-box-60 clearfix">
                    ...
                    <Button class="filterQuery-add" size="small" @click="addAttribute('$form', formAttribute)">添加</Button>
                  </div>
                </Col>
              </TabPane>
            </Tabs>
...
<script>
  ...
  export default {
    ...
    watch: {
      // finallyFilterQueryCommon(val){
      //   this.finallyFilterQuery = val;
      // },
      //
      // finallyFilterQueryNative(val){
      //   this.finallyFilterQuery = val;
      // }
    },
    methods: {
      ...
      async initModal(filterQuery, refClass, options, tabFlag, classType) {
        ...
        if(this.filterQueryType === 'common'){
          this.finallyFilterQueryCommon = filterQuery || '';
          this.finallyFilterQueryNative = '';
        }else{
          this.finallyFilterQueryNative = filterQuery || '';
      ...
      confirmFilterQuery() {
        ...
        this.$emit('generatorFilterQuery', this.finallyFilterQuery);
      },
      /**
       * @description增加条件
       */
      addAttribute(type, attribute, prefix = ''){
        let attributeName = attribute.attributeName;
        let displayName = attribute.displayName;
        if(this.filterQueryType === 'common'){ // 快速查询
          switch (type) {
            case 'obj':
              if (this.externalItemClass && prefix === '') { // 外部实体类属性加双引号，and obj."ATTR_NAME"
                this.finallyFilterQueryCommon = !this.finallyFilterQueryCommon ? `and ${type}."${attributeName}"` : `${this.finallyFilterQueryCommon} and ${type}."${attributeName}"`;
              } else {
                if(this.classType === 're'){
                  this.finallyFilterQueryCommon = !this.finallyFilterQueryCommon ? `and ${type}.${prefix}${attributeName}` : `${this.finallyFilterQueryCommon} and ${type}.${prefix}${attributeName}`;
                }else{
                  //关联类管理的情况
                  this.finallyFilterQueryCommon = !this.finallyFilterQueryCommon ? `and ${type}.${attributeName}` : `${this.finallyFilterQueryCommon} and ${type}.${attributeName}`;
                }
              ...
              break;
            case '$obj':
              this.finallyFilterQueryCommon = this.intType.includes(attribute.valueType) ? `${this.finallyFilterQueryCommon} = ${type}.${prefix}${attributeName}` : `${this.finallyFilterQueryCommon} = '${type}.${prefix}${attributeName}'`;
              break;
            case '$form':
              this.finallyFilterQueryCommon = this.intType.includes(attribute.valueType) ? `${this.finallyFilterQueryCommon} = ${type}["${displayName}"]` : `${this.finallyFilterQueryCommon} = '${type}["${displayName}"]'`;
              break;
            default:
          ...
          switch (type) { // 原生查询
            case 'obj':
              if (this.externalItemClass) { // 外部实体类属性加双引号，and "ATTR_NAME"
                this.finallyFilterQueryNative = !this.finallyFilterQueryNative ? `and "${attributeName}"` : `${this.finallyFilterQueryNative} and "${attributeName}"`;
              } else {
                if(this.classType === 're'){
                  let _prefix = prefix.replace('_', '');
                  this.finallyFilterQueryNative = !this.finallyFilterQueryNative ? `and ${_prefix}class.plt_${attributeName}` : `${this.finallyFilterQueryNative} and ${_prefix}class.plt_${attributeName}`;
                }else{
                  //关联类管理的情况
                  let _prefix = prefix.replace('_', '.');
                  this.finallyFilterQueryNative = !this.finallyFilterQueryNative ? `and plt_${attributeName}` : `${this.finallyFilterQueryNative} and plt_${attributeName}`;
                }
              }
              break;
            case '$obj':
              ...
              break;
            case '$form':
              this.finallyFilterQueryNative = `${this.finallyFilterQueryNative} = '${type}["${displayName}"]'`;
              break;
            default:
