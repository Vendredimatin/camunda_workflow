            ...
            <span v-show="t_edit" ref="edit">
                ...
                :targetclass="itemValue.data.targetClass">
                    <div slot="attribute">
                        ...
                        <Select class="margin1" name="" id="" v-model="args.type" filterable @on-change="changeType">
                            <Option v-for="item in inputTypeList" :value="item.value" :key="item.value">{{item.value}}</Option>
                        </Select>
                        <p class="margin1" v-show="args.type == 'textarea'">最大行数</p>
                        <InputNumber class="margin1" v-show="args.type == 'textarea'" :min="1" style="width: 100%;" v-model="args.maxAreaRow"></InputNumber>
                        <p class="margin1">占位文本</p>
                        <Input class="margin1" type="text" v-model="args.placeholder" />
                        <div v-show="args.type != 'textarea'">
...
export default {
  ...
  methods: {
    ...
    changeType(value) {
      ...
      } else if(this.args.widthType == 'px'){
        this.args.height = 30;
      }
