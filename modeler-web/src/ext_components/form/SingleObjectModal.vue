...
<span v-show="t_edit" ref="edit">
            ...
            >
                <div slot="attribute">
                    ...
                    <Select class="margin1 editbox-single-object-modal" v-model="args.returnFormat" filterable multiple
                  ...
                  <!--                   :disabled="displayFormatFlag"-->
                    <Select class="margin1 editbox-single-object-modal" v-model="args.displayFormat" filterable multiple>
                    ...
                    <Input class="margin1" v-model="args.groupName" placeholder="输入联动组代号"
                           @on-blur="handleGroupNameChange" :disabled="args.selectMulti == true"/>
                  ...
                  <p class="margin1">弹窗高度自适应</p>
                  <i-switch v-model="args.dialogAutoHeight"></i-switch>
  ...
  <section v-else :addinName="name">
        <span style="text-align:center">
            ...
            <Tooltip class="form-addin-name" content="单对象弹窗" style="width: 100%;" :transfer="true">对象弹窗</Tooltip>
        </span>
  </section>
...
<style>
.editbox-single-object-modal .ivu-select-dropdown {
  width: 100%!important;
}
</style>
<style scoped>
