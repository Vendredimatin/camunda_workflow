...
ManualTaskInstance.prototype.parse = function(json) {
  ...
  this.formContent = json.formContent;
  this.formName = json.formName;
  this.goAhead = json.goAhead;
  this.beforeOperation = json.beforeOperation;
  this.afterOperation = json.afterOperation;
...
ManualTaskInstance.prototype.stringifyforJSON = function() {
  ...
  a.formName = this.formName;
  a.beforeOperation = this.beforeOperation;
  a.afterOperation = this.afterOperation;
  a.goAhead = this.goAhead;
