...
EndPointInstance.prototype.parse = function(json) {
	...
	this.endFormContent = json.endFormContent;
	this.endFormName = json.endFormName;
	this.endOperation = json.endOperation;
...
EndPointInstance.prototype.stringifyforJSON = function() {
	...
	a.endOperation = this.endOperation;
	...
	a.endFormName = this.endFormName;
