...
function WfProcessInstance() {
	...
	this.startTime = -1;
	/**
	 * this is a long integer array mobileNumberdue to possible multiple suspension. the
...
WfProcessInstance.prototype.parseFromJSON = function(json) {
	console.log("wfproInstance json",json);
	this.id = json.id;
	this.code = json.code;
	this.name = json.name;
	...
	this.bindEnClassName = json.bindEnClassName;
    ...
    this.proprietors = json.proprietors;
    this.enClassInstanceId = json.enClassInstanceId;
...
WfProcessInstance.prototype.stringifyforJSON = function() {
	...
	proc.proprietors = this.proprietors;
	proc.enClassInstanceId = this.enClassInstanceId;
