...
StartPoint.prototype.stringifyforJSON = function() {
	...
	a.launchFormName = this.launchFormName;
	a.startOperation = this.startOperation;
...
StartPoint.prototype.parse = function(json) {
	...
	this.launchFormContent = json.launchFormContent;
	this.launchFormName = json.launchFormName;
	this.startOperation = json.startOperation;
