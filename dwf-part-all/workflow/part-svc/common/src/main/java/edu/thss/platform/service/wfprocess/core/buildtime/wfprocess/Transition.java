...
public class Transition extends WorkflowEntity implements Comparable<Transition>, TransitionStatus {
	 ...
	 * @return
	 * @see edu.thss.platform.service.wfprocess.core.buildtime.wfprocess.Transition#isAlwaysTrue()
	 */
	 ...
	 * @date 19/05/2011 11:22:22 AM
	 * @param alwaysTrue
	 * @see edu.thss.platform.service.wfprocess.core.buildtime.wfprocess.Transition#setAlwaysTrue(boolean)
	 */
...
//		System.out.println("setStatus:::"+status);
	 ...
	 * @return
	 * @see edu.thss.platform.service.wfprocess.core.buildtime.wfprocess.Transition#getStatusName()
	 */
