 ...
 * 
 */
package edu.thss.platform.service.wfprocess.core.runtime.workitem;
...
public class WorkitemInfoDescriptor extends TreeNode {
	...
	private String wfProcessVerison = null;
	// this is status is edu.thss.platform.service.wfprocess.core.buildtime.wfprocess.WfProcessStatus
	...
	public void setWfProcessVerison(String wfProcessVerison) {
		this.wfProcessVerison = wfProcessVerison;
	}

	public String getWfProcessVerison() {
		return wfProcessVerison;
	}
