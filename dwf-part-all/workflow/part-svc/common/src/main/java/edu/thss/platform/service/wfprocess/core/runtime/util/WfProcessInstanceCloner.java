...
import edu.thss.platform.service.wfprocess.core.buildtime.util.WfProcessCloner;
...
public class WfProcessInstanceCloner extends WfProcessCloner {
    ...
    public static void cloneCommonPIProps(WfProcessInstance p, WfProcessInstance pi) {
        ...
        p.setEnClassInstanceId(pi.getEnClassInstanceId());
//        p.setInvitations(pi.getInvitations());
//        p.setCclist(pi.getCclist());
        p.setInvitations(copyStringList(pi.getInvitations()));
        p.setCopiers(copyStringList(pi.getCopiers()));
        p.setCustomData(pi.getCustomData());
//        String[] invites = pi.getInvitations();
//        if (invites != null && invites.length > 0) {
//            String[] invites1 = new String[invites.length];
//            for (int i = 0; i < invites.length; i++) invites1[i] = invites[i];
//            p.setInvitations(invites1);
//        }
//        String[] copiers = pi.getCclist();
//        if (copiers != null && copiers.length > 0) {
//            String[] copiers1 = new String[copiers.length];
//            for (int i = 0; i < copiers.length; i++) copiers1[i] = copiers[i];
//            p.setCclist(copiers1);
//        }


    }
    public static String[] copyStringList(String[] copy){
        if (copy != null && copy.length > 0) {
            String[] copy1 = new String[copy.length];
            for (int i = 0; i < copy.length; i++) copy1[i] = copy[i];
            return copy1;
        }
        return null;
    }
    ...
    public static AbstractTask cloneTaskInstance(TreeNode task) {
        ...
        if (t instanceof StartPointInstance) {
            ...
            // runtime props
            ManualTaskInstance mt = (ManualTaskInstance) t;
            ...
            a.setCandidates(cloneCandidates(mt.getCandidates()));
//            a.setInvitations(mt.getInvitations());
//            a.setComments(cloneComments(a.getComments()));
            a.setMessages(cloneCommunicationMessage(mt.getMessages()));
            a.setComments(cloneComments(mt.getComments()));
            a.setGoAhead(((ManualTaskInstance) t).getGoAhead());
            a.setLastTaskId(((ManualTaskInstance) t).getLastTaskId());
...
//            }
    ...
    // clone comments
//    public static String[] cloneComments(String[] comments) {
//        if (comments != null && comments.length > 0) {
//            String[] invites1 = new String[comments.length];
//            for (int i = 0; i < comments.length; i++) {
//                invites1[i] = comments[i];
//            }
//            return invites1;
//        }
//        return new String[0];
    ...
    public static Comment[] cloneComments(Comment[] comments) {
        if (comments != null && comments.length > 0) {
            ...
            for (int i = 0; i < comments.length; i++) {
                ...
                c.setContentType(comments[i].getContentType());
