package edu.thss.platform.service.wfprocess.core.buildtime.util;
...
import edu.thss.platform.service.wfprocess.core.data.variable.ParameterUtil;
...
public class WfProcessCloner {
    ...
    protected static void cloneCommonProps(WfProcess proc, WfProcess process) {
        ...
        proc.setBindEnClassName(process.getBindEnClassName());
        // proc.setBindEnClassId(process.getBindEnClassId());
        proc.setProprietors(process.getProprietors());

    }

    // clone ReleasedWfProcess
...
//        proc.setBindEnClassId(process.getBindEnClassId());
    ...
    protected static void setStartPointProp(StartPoint a, StartPoint t) {
        ...
        a.setLaunchFormName(t.getLaunchFormName());
        a.setStartOperation(t.getStartOperation());
    ...
    protected static void setEndPointProp(EndPoint a, EndPoint t) {
        ...
        a.setEndFormName(t.getEndFormName());
        a.setEndFormContent(t.getEndFormContent());
        a.setEndOperation(t.getEndOperation());
        a.setAccessibleVars(cloneAccessibleVariable(t.getAccessibleVars()));
    }
    ...
    protected static void setManualTaskProp(ManualTask a, ManualTask t) {
        ...
        a.setFormName(t.getFormName());
        a.setBeforeOperation(t.getBeforeOperation());
        a.setAfterOperation(t.getAfterOperation());

//        a.setAccessibleVars(t.getAccessibleVars());
        a.setFormContent(t.getFormContent());
        a.setAccessibleVars(cloneAccessibleVariable(t.getAccessibleVars()));
        a.setParticipants(t.getParticipants());
...
//            System.out.println("t.getNavigationRule():"+t.getNavigationRule());
//           a.setNavigationRule(((Expression) t.getNavigationRule()).toExpressionString());
            if (t.getNavigationRule() instanceof String) {
                try {
                    t.setNavigationRule(new Expression((String) t.getNavigationRule()));
                } catch (Exception e1) {
                    e1.printStackTrace();
                }
            } else {
