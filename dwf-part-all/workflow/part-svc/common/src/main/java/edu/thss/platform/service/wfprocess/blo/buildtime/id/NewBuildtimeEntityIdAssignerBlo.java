...
public class NewBuildtimeEntityIdAssignerBlo {
	 ...
	 * @throws Exception
	 */
	public void assignChildrenNewEntityId(TreeNode node, TreeNode owner) throws Exception {
...
//							JSONObject fj = new JSONObject(newf);
							((StartPoint) child).setLaunchFormContent(newf);
						}
					}
...
//							((ManualTask) child).setFormContent(newContent);
							((ManualTask) child).setFormContent(str);
						}
					}
