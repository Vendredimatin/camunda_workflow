 ...
 *
 */
package edu.thss.platform.service.wfprocess.core.buildtime.util.json;
...
//        if (!obj.isNull("bindEnClassId")) {
//            newprocess.setBindEnClassId(obj.getString("bindEnClassId"));
//        }
    }
...
//        }
    ...
    private static void parseTransitions(JSONArray jsonarr, WfProcess newprocess) throws Exception{
